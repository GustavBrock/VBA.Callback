...
'   ColumnWidths:   Don't care. Will be overridden by the function
'
' 2021-02-18. Cactus Data ApS, CPH.
'
...
'
' 2021-02-18. Gustav Brock. Cactus Data ApS, CPH.
'
            ...
            Select Case Id
                ...
                Case ActionId                           ' Custom call. Set one optional value.
                    ...
                    Select Case Row
                        ...
                        Case StartDateId                ' Start date.
                            OptionalValues(StartDateOption, ControlIndex) = CDate(Column)
                        Case RowCountId                 ' Count of weeks to list.
...
'
' 2021-02-07. Cactus Data ApS, CPH.
'
        ...
        If ControlType = acListBox Or ControlType = acComboBox Then
            If Control.RowSourceType = FunctionName Then
                ...
                If DateDiff("d", StartDate, #12:00:00 AM#) <> 0 Then
                    Application.Run FunctionName, Control, ActionId, StartDateId, CLng(DateValue(StartDate)), acLBOpenAsVariant
                    SetValue = True
                End If
                If RowCount > 0 Then
...
'
' 2021-01-16. Cactus Data ApS, CPH.
'
